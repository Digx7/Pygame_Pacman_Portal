...
class StartUI():
    ...
    def __init__(self, settings, screen, stats):
        ...
        self.texts.setup_H1s(title1="Pacman")
        self.texts.setup_H2s(title2="Portal", LeaderBoard_Header="Leader-Board")
        self.texts.setup_texts(score1_label="1st:",
                               score1_value="000",
                               score2_label="2nd:",
                               score2_value="000",
                               score3_label="3rd:",
        ...
        self.texts.setup_sub_texts(credit="Developed by: Everette",
                                   version_num="1.0")

        self.ghost_img2 = self.settings.sprites["p"]
        self.ghost_img1 = self.settings.sprites["blinky_move1"]
        self.ghost_img1_rect = self.ghost_img1.get_rect()
        self.ghost_img2_rect = self.ghost_img2.get_rect()
        self.ghost_img2_rect.center = self.screen.get_rect().center
        self.ghost_img1_rect.bottom = self.ghost_img2_rect.top
        # self.ghost_img1_rect.centerx = self.ghost_img2_rect.centerx
    ...
    def draw_main_menu(self):
        ...
        self.screen.blit(self.ghost_img1, self.ghost_img1_rect)
        self.screen.blit(self.ghost_img2, self.ghost_img2_rect)
    ...
    def draw_build_info(self):
        self.texts.sub_texts["credit"].msg_image_rect.left = self.screen_rect.left + 10
        self.texts.sub_texts["credit"].msg_image_rect.bottom = self.screen_rect.bottom - 10
        self.texts.sub_texts["version_num"].msg_image_rect.left = self.screen_rect.left + 10
        self.texts.sub_texts["version_num"].msg_image_rect.bottom = self.texts.sub_texts["credit"].msg_image_rect.top

        self.texts.draw_text("credit", "sub_text")
        self.texts.draw_text("version_num", "sub_text")
...
class Texts():
    ...
    def setup_H1s(self, **msgs):
        ...
        for key in self.H1s:
            self.H1s[key] = Text(self.settings, self.screen, self.H1s[key], self.settings.palette.color["header1"], 150)

    def setup_H2s(self, **msgs):
        self.H2s = msgs

        for key in self.H2s:
            self.H2s[key] = Text(self.settings, self.screen, self.H2s[key], self.settings.palette.color["header2"], 125)
    ...
    def setup_sub_texts(self, **msgs):
        self.sub_texts = msgs

        for key in self.sub_texts:
            self.sub_texts[key] = Text(self.settings, self.screen, self.sub_texts[key], self.settings.palette.color["sub_text"])
    ...
    def update_text(self, m, text_type, new_msg):
        ...
        elif text_type == "sub_text": self.sub_texts[m].update_text(new_msg)
    ...
    def draw_text(self, m, text_type):
        ...
        elif text_type == "sub_text": self.sub_texts[m].draw_text()
    ...
    def draw_text_absolute(self, m, text_type, pos):
        ...
        elif text_type == "sub_text": self.sub_texts[m].draw_text_absolute()
    ...
    def draw_text_alignx_center(self, m, text_type, y):
        ...
        elif text_type == "sub_text": self.sub_texts[m].draw_text_alignx_center()
